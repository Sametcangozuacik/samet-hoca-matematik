...
export default function Membership() {
    return (
        <div className={styles.memberShipSection}>
            <h1 className={styles.memberShipSectionHeading}>Ders Alabileceğim En İyi Öğretmenlere Nasıl Ulaşabilirim?</h1>
