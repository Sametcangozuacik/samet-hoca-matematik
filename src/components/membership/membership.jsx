        ...
        <div className={styles.memberShipSection}>
            ...
            <div className={styles.memberShipSectionContent}>
                ...
                <div className={styles.memberShipSectionContentText}>
                    <h6 className={styles.stepTitle}>1. Adım</h6> {/* Yeni sınıf ismi eklenmiştir */}
            ...
            <div className={styles.memberShipSectionContent}>
                <div className={styles.memberShipSectionContentText}>
                    <h6 className={styles.stepTitle}>2. Adım</h6> {/* Yeni sınıf ismi eklenmiştir */}
                    <p className={styles.memberShipParagraph}>
            ...
            <div className={styles.memberShipSectionContent}>
                ...
                />
                <div className={styles.memberShipSectionContentText}>
                    <h6 className={styles.stepTitle}>3. Adım</h6> {/* Yeni sınıf ismi eklenmiştir */}
                    <p className={styles.memberShipParagraph}>
